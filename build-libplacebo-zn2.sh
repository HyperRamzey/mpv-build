#!/bin/bash
# ==============================================================================
# Build libplacebo for Zen2 (znver2) — STATIC install into deps-zn2.
...
LOG=/g/media-build/mpv-build/configure-libplacebo-zn2.log
...
echo "libplacebo zn2: PL_API_VER=$PL_API_VER -> $DEPS"
