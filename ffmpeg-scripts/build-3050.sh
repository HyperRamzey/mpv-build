...
PREFIX=/g/ffmpeg-build/install-3050
LOG=/g/ffmpeg-build/configure-3050.log
DEPS=/g/deps-build/deps-3050
cd "$SRC"
...
make LD="$DEPS/wat4ff_ld" WAT4FF_TRUELD=clang -j14 2>&1 | tee /g/ffmpeg-build/make-3050.log | grep -E '^(CC|CXX|LD|CUDA|error|Error|warning:)' | tail -5
echo "=== MAKE EXIT: $? ==="
