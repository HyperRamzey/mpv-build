#!/bin/bash
# ==============================================================================
# Build libplacebo for x64v4 (skylake-avx512) — STATIC install into deps-x64v4.
...
LOG=/g/media-build/mpv-build/configure-libplacebo-x64v4.log
...
echo "libplacebo x64v4: PL_API_VER=$PL_API_VER -> $DEPS"
