#!/bin/bash
# ==============================================================================
# Build libplacebo for 14600 (raptorlake) — STATIC install into deps-14600.
...
LOG=/g/media-build/mpv-build/configure-libplacebo-14600.log
...
echo "libplacebo 14600: PL_API_VER=$PL_API_VER -> $DEPS"
