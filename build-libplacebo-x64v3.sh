#!/bin/bash
# ==============================================================================
# Build libplacebo for x64v3 (haswell) — STATIC install into deps-x64v3.
...
LOG=/g/mpv-build/configure-libplacebo-x64v3.log
...
echo "libplacebo x64v3: PL_API_VER=$PL_API_VER -> $DEPS"
