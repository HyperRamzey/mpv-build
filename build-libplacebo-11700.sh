#!/bin/bash
# ==============================================================================
# Build libplacebo for Intel 11700 (rocketlake) — STATIC install into deps-11700.
...
LOG=/g/media-build/mpv-build/configure-libplacebo-11700.log
...
echo "libplacebo 11700: PL_API_VER=$PL_API_VER -> $DEPS"
